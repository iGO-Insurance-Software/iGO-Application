...
//            ////////////////////////////////////////////////////
            switch (userChoiceValue){
                // 1. 보험 가입 신청 현황 확인
                case "1":
                    ArrayList<Contract> waitingContract = contractDao.retrieveAllCustomerWait("가입신청");
                    ...
                    switch (userChoiceValue){
                        case "1":
                            ...
                            break;
                        case "2":
//                            ArrayList<Contract> finishedContract = contractDao.retrieveAllWaitStateContract("df");
